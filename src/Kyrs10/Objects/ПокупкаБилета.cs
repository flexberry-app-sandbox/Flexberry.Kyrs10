...
namespace IIS.Kyrs10
{
    ...
    public class ПокупкаБилета : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kyrs10.Покупатель fПокупатель;
        
        private IIS.Kyrs10.ПокупИлиВозвБ fПокупИлиВозвБ;
        ...
        [PropertyStorage(new string[] {
                "Покупатель"})]
        [NotNull()]
        public virtual IIS.Kyrs10.Покупатель Покупатель
        {
            get
            {
                ...
                IIS.Kyrs10.Покупатель result = this.fПокупатель;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Kyrs10.ПокупИлиВозвБ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПокупИлиВозвБ"})]
        public virtual IIS.Kyrs10.ПокупИлиВозвБ ПокупИлиВозвБ
        {
            get
            {
                ...
                IIS.Kyrs10.ПокупИлиВозвБ result = this.fПокупИлиВозвБ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПокупкаБилетаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПокупкаБилетаE", typeof(IIS.Kyrs10.ПокупкаБилета));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПокупкаБилета : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Kyrs10.DetailArrayOfПокупкаБилета members)

        // *** End programmer edit section *** (IIS.Kyrs10.DetailArrayOfПокупкаБилета members)
        ...
        /// </summary>
        public DetailArrayOfПокупкаБилета(IIS.Kyrs10.ПокупИлиВозвБ fПокупИлиВозвБ) : 
                base(typeof(ПокупкаБилета), ((ICSSoft.STORMNET.DataObject)(fПокупИлиВозвБ)))
        {
        }
        
        public IIS.Kyrs10.ПокупкаБилета this[int index]
        {
            get
            {
                return ((IIS.Kyrs10.ПокупкаБилета)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Kyrs10.ПокупкаБилета dataobject)
        {

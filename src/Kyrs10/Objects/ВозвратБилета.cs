...
namespace IIS.Kyrs10
{
    ...
    public class ВозвратБилета : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВозвратБилетаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВозвратБилетаE", typeof(IIS.Kyrs10.ВозвратБилета));
                }
            }
        }
    }
    ...
    public class DetailArrayOfВозвратБилета : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Kyrs10.DetailArrayOfВозвратБилета members)

        // *** End programmer edit section *** (IIS.Kyrs10.DetailArrayOfВозвратБилета members)
        ...
        /// </summary>
        public DetailArrayOfВозвратБилета(IIS.Kyrs10.ПокупИлиВозвБ fПокупИлиВозвБ) : 
                base(typeof(ВозвратБилета), ((ICSSoft.STORMNET.DataObject)(fПокупИлиВозвБ)))
        {
        }
        
        public IIS.Kyrs10.ВозвратБилета this[int index]
        {
            get
            {
                return ((IIS.Kyrs10.ВозвратБилета)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Kyrs10.ВозвратБилета dataobject)
        {
